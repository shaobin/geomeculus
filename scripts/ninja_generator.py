...
compile_flags = -O3 -fno-strict-aliasing -Wall -fPIC -I{src_dir}{cuda_compile_flags}{compile_debug_flags}{trace_flags}{cmd_line_provided_compile_flags}
extra_compile_flags =
link_flags = -O3 -fno-strict-aliasing -Wall{cuda_link_flags}{link_debug_flags}{cmd_line_provided_link_flags}
extra_link_flags =
nvcc_flags ={nvcc_flags}
compile_cu_flags ={cuda_compile_flags}{nvcc_compile_debug_flags}{trace_flags}
nvcc_extra_compile_flags =
nvcc_link_flags ={nvcc_link_flags}{nvcc_link_debug_flags}
...
def generate_ninja_script(debug=False):
    def write_ninja_preamble(writer):
        ...
        compile_debug_flags = " -DDEBUG -g" if debug else ""
        nvcc_compile_debug_flags = " -DDEBUG -g" if debug else ""
        link_debug_flags = " -g" if debug else ""
        nvcc_link_debug_flags = " -g -G" if debug else ""
        cuda_compile_flags = (
        ...
        trace_flags = " -DTRACE_MEMORY" if config["trace_memory"] else ""
        ...
        writer.write(
            ninja_preamble.format(
                ...
                nvcc_compile_debug_flags=nvcc_compile_debug_flags,
                link_debug_flags=link_debug_flags,
                nvcc_link_debug_flags=nvcc_link_debug_flags,
