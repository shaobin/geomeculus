...
/* 1/ln(2) */
#define ONE_OVER_LN2 1.44269504088896340736

/* 1/ln(10) */
#define ONE_OVER_LN10 0.434294481903251827651

extern u32 const U32_ZERO;
extern u32 const U32_ONE;

extern i32 const I32_ZERO;
extern i32 const I32_ONE;

extern u64 const U64_ZERO;
extern u64 const U64_ONE;

extern i64 const I64_ZERO;
extern i64 const I64_ONE;
